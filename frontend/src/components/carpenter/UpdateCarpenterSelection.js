...
class CarpenterSelection extends Component {
    ...
    // search handlers for search filter
    ...
    render() {
        ...
        return (
            <main className="main">
            {/* Carpenter Recommendation page starts from here */}
            <h1>Carpenter Selection</h1>
            {this.state.roundedCarpCosts}
            <hr/>
                                        ...
                                        <table className="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="text-left"><h5><b>Name</b></h5></th>
                                                    <th className="text-center"><h5><b>Action</b></h5></th>
                                                    <th className="text-center"><h5><b>Rating</b></h5></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            
                                                {
                                                    ...
                                                    this.state.suggestedcarpenters.map(recommendedCarpenter => {
                                                        return (
                                                            <tr className="user" key={recommendedCarpenter.id}>
                                                                <td>
                                                                    <input name="carpenter_id" type="checkbox" class="checkbox checked"  value={recommendedCarpenter.id} onChange={handleChange('carpenter_id')}/>
                                                                </td>                                                                
                                                                <td>{recommendedCarpenter.name}</td>
                                                                <td><img className="userImage" src={userLogo} alt="" /> &nbsp; {recommendedCarpenter.carpenter_name}</td>
                                                                ...
                                                                <td className="text-center">
                                                                        <ReactStars classNames="rating text-center"
                                                                            count={5}
                                                                            size={20}
                                                                            value={recommendedCarpenter.carpenter_rate}
                                                                            edit={false}
                                                                            isHalf={true}
                                                                            activeColor="#ffd000"
                                                                        />
                                                                        <div className="text-center">{recommendedCarpenter.carpenter_rate}</div>
                                                                </td>
                                                            </tr>
                                                        )
                                                    })
                                                    ...
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td></td>
                                                        <td className="text-center">No Carpenter recommendation ??? Try the search filter to find a perfect carpenter for your requirements....</td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                }
