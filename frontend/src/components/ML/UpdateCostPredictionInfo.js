...
export class UpdateCostPredictionInfo extends Component {
    ...
    render() {
        ...
        return (
            <main className="main-expand">
                ...
                {/* House Construction Cost Prediction info page content */}
                <div>
                            ...
                            <form action="/predict_cost_v2" method="POST" onSubmit={this.handleForm} >
                                    <div className="form-row d-flex justify-content-center">
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <input type="text" className="form-control" id="validationServer01" name="construction_projectName" value={construction_projectName} onChange={handleChange('construction_projectName')} required />
                                        </div>
                                    </div>
                                    <div className="form-row d-flex justify-content-center">
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <input type="number" className="form-control" id="validationServer01" name="area" value={area} onChange={handleChange('area')} required />
                                        </div>
                                        <div className="col-md-3 mb-3">
                                            {/* Height */}
                                            <label htmlFor="validationServer01">Height :</label>
                                            <input type="number" className="form-control" id="validationServer01" name="height" value={height} onChange={handleChange('height')} required />
                                        </div>
                                    </div>
                                    <br/>
                                    <hr/>
                                    ...
                                    <div className="form-row d-flex justify-content-center">
                                        ...
                                        <div className=" col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_floors" value={no_floors} id="inputGroupSelect01" onChange={handleChange('no_floors')}>
                                        ...
                                        <div className=" col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_rooms" id="inputGroupSelect01" value={no_rooms} onChange={handleChange('no_rooms')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_bathrooms" id="inputGroupSelect01" value={no_bathrooms} onChange={handleChange('no_bathrooms')}>
                                            <option defaultValue>Choose...</option>
                                    ...
                                    <div className="form-row d-flex justify-content-center">
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_doors" id="inputGroupSelect01" value={no_doors} onChange={handleChange('no_doors')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_windows" id="inputGroupSelect01" value={no_windows} onChange={handleChange('no_windows')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="wall_material" id="inputGroupSelect01" value={wall_material} onChange={handleChange('wall_material')}>
                                            <option defaultValue>Choose...</option>
                                    ...
                                    <div className="form-row d-flex justify-content-center">
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="celing_material" id="inputGroupSelect01" value={celing_material} onChange={handleChange('celing_material')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="floor_material" id="inputGroupSelect01" value={floor_material} onChange={handleChange('floor_material')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="roof_material" id="inputGroupSelect01" value={roof_material} onChange={handleChange('roof_material')}>
                                            <option defaultValue>Choose...</option>
                                    ...
                                    <div className="form-row d-flex justify-content-center">
                                        <div className="col-md-3 mb-3">
                                            ...
                                            {/* Timber type for Carpentry works */}
                                            <label htmlFor="validationServer01">Timber type for Carpentry works :</label>
                                            <select className="custom-select" name="timber_for_carpentry" id="inputGroupSelect01" value={timber_for_carpentry} onChange={handleChange('timber_for_carpentry')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            {/* Timber type for Ceilin */}
                                            <label htmlFor="validationServer01">Timber type for Ceiling :</label>
                                            <select className="custom-select" name="timber_for_celing" id="inputGroupSelect01" value={timber_for_celing} onChange={handleChange('timber_for_celing')}>
                                            <option defaultValue>Choose...</option>
                                            <option value="Mahogani">Mahogani</option>
                                            <option value="Thekka">Thekka</option>
                                            <option value="Burutha">Burutha</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="loc_situation" id="inputGroupSelect01" value={loc_situation} onChange={handleChange('loc_situation')}>
                                            <option defaultValue>Choose...</option>
                                    ...
                                    <div className="form-row d-flex justify-content-center">
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="loc_nature" id="inputGroupSelect01" value={loc_nature} onChange={handleChange('loc_nature')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_pillers" id="inputGroupSelect01" value={no_pillers} onChange={handleChange('no_pillers')}>
                                            <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_of_door_frames" id="inputGroupSelect01" value={no_of_door_frames} onChange={handleChange('no_of_door_frames')}>
                                                <option defaultValue>Choose...</option>
                                    ...
                                    <div className="col-md-3 mb-3">
                                            ...
                                            <select className="custom-select" name="no_of_window_frames" id="no_of_window_frames" value={no_of_window_frames} onChange={handleChange('no_of_window_frames')}>
                                                <option defaultValue>Choose...</option>
                                        ...
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <input type="number" className="form-control" id="validationServer01" name="no_of_walls" value={no_of_walls} onChange={handleChange('no_of_walls')} required />
                                        </div>
                                        <div className="col-md-3 mb-3">
                                            {/* number of walls */}
...
export default UpdateCostPredictionInfo